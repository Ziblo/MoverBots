...
public:
    ...
    public:
        // Constructor taking a reference to MoverBotHost
        MyServerCallbacks(MoverBotHost& _host) : host(_host) {} //automatically save _host as host
    ...
    private:
        MoverBotHost& host; //reference to the MoverBotHost instance
    };
...
private:
    ...
    std::list<BLECharacteristic*> botCharacteristicsList; //linked list of Bot Characteristics
    //BLECharacteristic* pBotCharacteristics[NUM_OF_BOT_CHARACTERISTICS];
