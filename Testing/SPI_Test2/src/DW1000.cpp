...
const SPISettings DW1000Class::_fastSPI = SPISettings(1000000, MSBFIRST, SPI_MODE2);
#else
const SPISettings DW1000Class::_fastSPI = SPISettings(1000000, MSBFIRST, SPI_MODE2);
#endif
const SPISettings DW1000Class::_slowSPI = SPISettings(1000000, MSBFIRST, SPI_MODE2);
...
void DW1000Class::commitConfiguration()
{
	...
	{
		//_antennaDelay.setTimestamp(16384);//default
